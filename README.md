...
TagMind 是一个面向内容团队的数字资产提炼检索 Agent。它为本地视频、音频、图片和文档建立内容级索引，让用户不必记住文件名，只需描述台词、画面、人物或正文，就能定位到真正需要的文件，甚至视频与音频中的具体时间点。
...
- 当前版本为纯前端与无状态设计，不提供账户系统、团队同步或服务端持久化，保障数据隐私安全。
...
TagMind 的目标很直接：不替创作者制造更多信息负担，而是消灭最机械、最重复的查找工作。
